...
public enum Planet {
	// Enym values are stored in CAPITALS as they are constants...
	// Information can be provided for each value via fields and a constructor
	...
	// Constructor is implicitly private (public causes a compilation error)
